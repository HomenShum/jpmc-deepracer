...
class Reward:
    ...
    def reward_function(self, params):
        ...
        if all_wheels_on_track and not is_offtrack:
            ...
            LOOKAHEAD_START = 4  # Adjust as needed
            LOOKAHEAD_END = 6
            ...
            if max_angle_diff <= 1.0:
                STEERING_THRESHOLD = 1.0  # degrees
                if abs_steering_angle > STEERING_THRESHOLD:
                    steering_penalty = 0.9  # Penalize by reducing reward
